  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <el-form-item :label="dataForm.typeList[dataForm.type] + '名称'" prop="name">
        <el-input maxlength="100" v-model="dataForm.name" :placeholder="dataForm.typeList[dataForm.type] + '名称'"></el-input>
      </el-form-item>
      ...
      <el-form-item v-if="dataForm.type === 1" label="菜单路由" prop="url" :class="{ 'is-required': dataForm.type === 1 }">
        <el-input maxlength="100" v-model="dataForm.url" placeholder="菜单路由"></el-input>
      </el-form-item>
      <el-form-item v-if="dataForm.type !== 0" label="授权标识" prop="perms">
        <el-input maxlength="100" v-model="dataForm.perms" placeholder="多个用逗号分隔, 如: user:list,user:create"></el-input>
      </el-form-item>
