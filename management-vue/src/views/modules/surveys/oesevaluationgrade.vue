...
<script>
  import AddOrUpdate from './oesevaluationgrade-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/surveys/oesevaluationgrade/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/surveys/oesevaluationgrade/delete'),
            method: 'post',
