  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      <el-form-item label="角色名称" prop="roleName">
        <el-input maxlength="20" v-model="dataForm.roleName" placeholder="角色名称"></el-input>
      </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        tempKey: -1 // 临时key, 用于解决tree半选中状态项不能传给后台接口问题.
      }
    },
    methods: {
      init (id) {
        ...
        this.$http({
          url: this.$http.adornUrl('/sys/menu/listByUser'),
          method: 'get',
